...
const LeaderBoard = () => {
  ...
  return (
    ...
    >
      <div className=" rounded-xl bg-red-600 py-2 flex right-2 text-center top-2 flex-col gap-y-1 overflow-y-scroll absolute scrollbar-hide w-[30vw]">
        <p className="text-[16px] font-semibold">
          your opponent is submitting algo...
        </p>
        <p className="text-right pr-14">01:15:30</p>
      </div>
      <img
        src="logo.png"
